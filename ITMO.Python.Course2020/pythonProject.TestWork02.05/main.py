...
measurementsArray1 = [11, 11.5, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11,
                      11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11,
                      11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11]
count = 0
while count < 100:
    measurementsArray1.append(11)
    count=count+1
measurementsNumber1 =len(measurementsArray1)

measurementsArray2 = [11, 11, 11, 11.6, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11,
                      11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11,
                      11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11]
count = 0
while count < 100:
    measurementsArray2.append(11)
    count=count+1
measurementsNumber2 = len(measurementsArray2)

inf = "Bubyrev Dmitriy"
mesurmentsArrayClass01 = mesurmentsResultCharlier(measurementsNumber1, measurementsArray1, inf)
mesurmentsArrayClass02 = mesurmentsResultCharlier(measurementsNumber2, measurementsArray2, inf)

#Последовательная работа
startedAtPosl = time.time()

mesurmentsArrayClass01.makeAllWork()
mesurmentsArrayClass02.makeAllWork()

finishedAtPosl = time.time()
print('Time for work:{}'.format(finishedAtPosl-startedAtPosl))

#Параллельная работа
startedAtParallel = time.time()

task11 = threading.Thread(target=mesurmentsArrayClass01.makeAllWork())
task12 = threading.Thread(target=mesurmentsArrayClass02.makeAllWork())
...
finishedAtParallel = time.time()
print('Time for parralell work:{}'.format(finishedAtParallel-startedAtParallel))


#Асинхронное програмирование.
classes = [mesurmentsArrayClass01, mesurmentsArrayClass02]
startedAsyncio = time.time()
futures = [clas.makeAllWork() for clas in classes]
loop = asyncio.get_event_loop()
#loop.run_until_complete(asyncio.wait(futures))
finishedAsyncio = time.time()
print('Time for async work:{}'.format(finishedAsyncio-startedAsyncio))
...
#mesurmentsArrayClass02.printClass()
