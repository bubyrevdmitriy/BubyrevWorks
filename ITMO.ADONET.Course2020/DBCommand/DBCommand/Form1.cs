...
namespace DBCommand
{
    public partial class Form1 : Form
    {
        ...
        string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=Northwind;Integrated Security=true";//Data Source=DESKTOP-VMCV9GK\SQLEXPRESS;Initial Catalog=School;Integrated Security=True
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                { 
                    MessageBox.Show("Ошибка! Таблица уже создана!");
                }
            }
        }
