...
namespace SavingDataSetXml
{
    public partial class Form1 : Form
    {
        ...
        private void FillDataSetButton_Click(object sender, EventArgs e)
        {
            ...
            OrdersAdapter.Fill(northwindDataSet1.Orders); CustomersGrid.DataSource = northwindDataSet1.Customers;
        }
        ...
        private void SaveXmlDataButton_Click(object sender, EventArgs e)
        {
            try 
            { 
                northwindDataSet1.WriteXml("Northwind.xml"); MessageBox.Show("Data save as XML");
            } 
            catch (Exception ex)
            { 
